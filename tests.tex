...
\begin{tikzpicture}
  \begin{axis}[view={0}{90}, enlargelimits=false, xlabel={$x$, м}, ylabel={$y$, м}, colorbar, width=0.9\textwidth, height=0.9\textwidth, point meta min=0.1, point meta max=0.6]
...
\begin{tikzpicture}
  \begin{axis}[view={0}{90}, enlargelimits=false, xlabel={$x$, м}, ylabel={$y$, м}, colorbar, width=0.9\textwidth, height=0.9\textwidth, point meta min=0.1, point meta max=0.6]
    \pgfplotstableread[skip first n=3]{data/test3/F-000000003000.tec}{\mytable}
    \addplot3 [surf, shader=interp] table [x=0, y=1, z=2] {\mytable};
  \end{axis}
\end{tikzpicture}
\caption{Насыщенность $S_w$ в момент времени $t=3000$с}
\end{minipage}
\vfill
\begin{minipage}[h]{0.47\textwidth}
\begin{tikzpicture}
  \begin{axis}[view={0}{90}, enlargelimits=false, xlabel={$x$, м}, ylabel={$y$, м}, colorbar, width=0.9\textwidth, height=0.9\textwidth, point meta min=0.1, point meta max=0.5]
    \pgfplotstableread[skip first n=3]{data/test3/F-000000000100.tec}{\mytable}
...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Насыщенность $S_n$ в момент времени $t=3000$с}
\end{minipage}
\vfill
\begin{minipage}[h]{0.47\textwidth}
\begin{tikzpicture}
  \begin{axis}[view={0}{90}, enlargelimits=false, xlabel={$x$, м}, ylabel={$y$, м}, colorbar, width=0.9\textwidth, height=0.9\textwidth, point meta min=0.1, point meta max=0.4]
    \pgfplotstableread[skip first n=3]{data/test3/F-000000000100.tec}{\mytable}
...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Насыщенность $S_g$ в момент времени $t=3000$с}
\end{minipage}
\end{center}
\end{figure}
\begin{figure}
...
\begin{minipage}[h]{0.47\textwidth}
\begin{tikzpicture}
  \begin{axis}[view={0}{90}, enlargelimits=false, xlabel={$x$, м}, ylabel={$y$, м}, colorbar, width=0.9\textwidth, height=0.9\textwidth, point meta min=100000, point meta max=110000]
    \pgfplotstableread[skip first n=3]{data/test3/F-000000000100.tec}{\mytable}
...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Давление $P_w$ в момент времени $t=3000$с}
\end{minipage}
\vfill
\begin{minipage}[h]{0.47\textwidth}
\begin{tikzpicture}
  \begin{axis}[view={0}{90}, enlargelimits=false, xlabel={$x$, м}, ylabel={$y$, м}, colorbar, width=0.9\textwidth, height=0.9\textwidth, point meta min=285, point meta max=320]
    \pgfplotstableread[skip first n=3]{data/test3/F-000000000100.tec}{\mytable}
...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Температура в момент времени $t=3000$с}
\end{minipage}
\end{center}
\end{figure}

\documentclass[10pt,pdf,hyperref={unicode}, color=usenames,dvipsnames]{beamer} %aspectratio=169-для 16:9
...
\include{presentation_base}
\include{presentation_algo}
\include{presentation_test}
\include{presentation_calc}
\include{presentation_conc}
